...
time_intervals2 = {'2015_2020','2021_2030','2031_2040','2041_2050','2051_2060', ...
                   '2031-2070','2071_2080','2081_2090','2091_2100'};
...
prefix = 'gfdl-esm4_r1i1p1f1_w5e5_historical_';
...
for i = 1 : length(scenarios)
    ...
    for j = 1 : length(vars)
        ...
        for k = 1 : length(time_intervals)
            url = [str1 scenarios{i} '/' vars{j} str2 prefix vars{j} suffix time_intervals{k} '.nc'];
            filename = ['./' scenarios{i} '/' vars{j} '/' prefix vars{j} suffix time_intervals{k} '.nc'];
